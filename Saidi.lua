...
ControllerAll = false
local ListSudos ={Sudo_Id,2002229504,5088706206}  
...
if tonumber(msg.sender.user_id) == 2002229504 then
...
--download('https://raw.githubusercontent.com/zoka00/17900/master/Saidi.lua','Saidi.lua')
...
data = {
{
{text = '◍ѕᴏᴜʀᴄᴇ ʟᴏʀᴅ 🥀𖤣', url = 't.me/S_a_i_d_i'}, 
},
}
}
...
{
{text = '◍ѕᴏᴜʀᴄᴇ ʟᴏʀᴅ 🥀𖤣', url = "https://t.me/S_a_i_d_i"}
},
}
local msgg = msg_id/2097152/0.5
...
local Namebot = (bot_data:get(ban_id..'Name:Bot') or 'لورد') 
local NASA_Msg = { 
'انا بوت اسمي  '..Namebot..'',
} 
Namebot = NASA_Msg[math.random(#NASA_Msg)] 
local msg_id = msg.id_/2097152/0.5  
if result.username_ then
user = result.username_ 
else
user = 'L_0_O_R_D'
end
if result.first_name_  then
Men = result.first_name_ 
else
Men = 'L_0_O_R_D'
end
PHOTO_BOT = bot_data:get(ban_id..'BO0T_PHOTO')
if PHOTO_BOT then
Photo = PHOTO_BOT 
else 
Photo = "https://t.me/apqiy/83"
end
...
keyboard.inline_keyboard = {
{
{text = '  مرحب عزيز'..Men..'  🐼🍇', url="http://t.me/"..user},
},
{
{text = texxtt, url="t.me/"..dofile("./Info.lua").botUserName.."?start"},
},
{
{text = 'ضفني للمجموعة ⦁',url="t.me/"..dofile("./Info.lua").botUserName.."?startgroup=start"},{text = ' مـطور الـبـوت⦁', url="http://t.me/"..sudos.UserName},
},
{
{text = 'القائمه التانيه ⦁', callback_data="/appointment"},
},
}
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo='..Photo..'&caption=' .. URL.escape(tex).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end,nil) 
end
end
end
...
if text == 'بلحه يستا' or text == 'سورس' or text == 'يا سورس' or text == 'source' then
tdcli_function({ID="GetUser",user_id_=msg.sender_user_id_},function(extra,ban,success)
Photo_Weloame = bot_data:get(ban_id..'WELCOME_sou')
if Photo_Weloame then
Photo = Photo_Weloame 
else 
Photo = "https://t.me/jdndnhdb/8"
end
if ban.first_name_  then
Men = ban.first_name_ 
else
Men = 'L_0_O_R_D'
end
if ban.username_ then
user = ban.username_ 
else
user = 'L_0_O_R_D'
end
local msg_id = msg.id_/2097152/0.5  
local Name = '⍟ ᴡᴇʟᴄᴏᴍᴇ ʏᴀ-> '..Rutba(msg.sender_user_id_,msg.chat_id_)..' \n⍟ ᴡᴇʟᴄᴏᴍᴇ sᴏᴜʀᴄᴇ ɴsᴀs𖤣\n'
ban = {} 
ban.inline_keyboard = {
{{text = '•  '..Men..'  •', url="http://t.me/"..user}},
{{text = '‌‌‏𓂁ᴍʏ ᴄʜᴀɴɴᴇʟ𓂄', callback_data="/theytry"},{text = '‌‌‏𓂁ᴍʏ ᴅᴇᴠ𓂄', callback_data="/units"}},     
{{text = ' اضغط لاضافه البوت لمجموعتك ' ,url="t.me/"..dofile("./Info.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo='..Photo..'&caption=' .. URL.escape(Name).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(ban))
end,nil)
end
